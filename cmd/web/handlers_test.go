...
func TestShowSnippet(t *testing.T) {
	...
	tests := []struct {
		...
		{"Valid ID", "/snippet/1", http.StatusOK, []byte("An old silent pound...")},
		...
		{"Hex ID", "/snippet/0x01", http.StatusNotFound, nil},
	}
...
func TestSignupUser(t *testing.T) {
	...
	tests := []struct {
		...
		{"Invalid email (incomplete domain)", "Bob", "bob@example.", "validPa$$word", csrfToken, http.StatusSeeOther, []byte("")},
		{"Invalid email (missing @)", "Bob", "bobexample.com", "validPa$$word", csrfToken, http.StatusSeeOther, []byte("")},
